...
router.post(
  ...
  async (req, res) => {
    ...
    // Build social object
    // we need to initialize a social object otherwise will throw an error because
    // profileFields.social is not defined
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    // Extract that index from experience array
    if (removeIndex === -1) {
